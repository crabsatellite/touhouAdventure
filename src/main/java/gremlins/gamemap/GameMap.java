...
public class GameMap {
    ...
    public GameMap(String gameMapLayout, double wizardAttackCooldown, double enemyAttackCooldown, char[][] mapDataMatrix){
    ...
    private void readGameData() {
        for (int row = 0; row < MAP_ROW; row++) {
            for (int col = 0; col < MAP_COLUMN; col++) {
                ...
                else if (mapDataMatrix[row][col] == 'U') superGremlinsList.add(new SuperGremlins(row, col, this));
